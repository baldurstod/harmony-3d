...
export class Source2SnapshotLoader {

	static async load(repository: string, filename: string): Promise<Source2Snapshot | null> {
	...
	static #loadSnapshot(snapFile: Source2File): Source2Snapshot {
