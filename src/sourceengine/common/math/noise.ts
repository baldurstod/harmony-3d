...
import { AddSIMD, Four_PointFives, Four_Twos, Four_Zeros, MulSIMD, SubSIMD } from '../../common/math/sse';
import { impulse_xcoords, perm_a, perm_b, perm_c } from './noisedata';

const NOISE_MAGIC_NUMBER = (1 << 15);
const NOISE_MASK255 = (0xffff);


function GetLatticePointValue(idx_x: number, idx_y: number, idx_z: number): number {
