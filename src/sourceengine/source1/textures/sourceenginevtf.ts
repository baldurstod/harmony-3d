import { ENABLE_S3TC, TESTING } from '../../../buildoptions.js';
import { Detex } from '../../../textures/detex.js';
...
import { TEXTUREFLAGS_CLAMPS, TEXTUREFLAGS_CLAMPT, TEXTUREFLAGS_SRGB, TEXTUREFLAGS_EIGHTBITALPHA, TEXTUREFLAGS_ENVMAP, TEXTUREFLAGS_ONEBITALPHA } from './vtfconstants.js';

export class SourceEngineVTF {
	repository: string;
	fileName: string;
	versionMaj: number = null;
...
function fillTextureDxt(graphics, glContext, texture, target, width, height, dxtLevel, datas, clampS, clampT, srgb) {//removeme
