...
export function CalcPose2(dynamicProp, pStudioHdr, pIKContext, pos, q, boneFlags: number[], sequence, cycle, poseParameter, boneMask, flWeight, flTime) {
...
function CalcPoseSingle2(dynamicProp, pStudioHdr, pos, q, boneFlags: number[], seqdesc, sequence, cycle, poseParameter, boneMask, flTime) {
	let bResult = true;
...
//			adds autolayers, runs local ik rukes
//-----------------------------------------------------------------------------
const AddSequenceLayers2 = function (dynamicProp, pStudioHdr, pIKContext, pos, q, boneFlags: number[], seqdesc, sequence, cycle, poseParameter, boneMask, flWeight, flTime) {
	//return;
...
function AccumulatePose2(dynamicProp, pStudioHdr, pIKContext, pos, q, boneFlags: number[], sequence, cycle, poseParameter, boneMask, flWeight, flTime) {
	//const pos2 = [];
	//const q2 = [];
...
//			adds autolayers, runs local ik rukes
//-----------------------------------------------------------------------------
function AddLocalLayers2(dynamicProp, pStudioHdr, pIKContext, pos, q, boneFlags: number[], seqdesc, sequence, cycle, poseParameter, boneMask, flWeight, flTime) {
	if (!(seqdesc.flags & STUDIO_LOCAL)) {
		return;
	}
