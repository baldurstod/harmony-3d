...
import { SourceEngineVTF } from '../textures/sourceenginevtf';
...
import { MAX_IMAGES_PER_FRAME_ON_DISK, SEQUENCE_SAMPLE_COUNT, MAX_IMAGES_PER_FRAME_IN_MEMORY, SheetSequenceSample_t, GetInterpolationData } from './sheet';
